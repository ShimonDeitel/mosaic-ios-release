...
extension Color {
    static let mosaicAccent = Color(hex: "#007AFF")          // the single accent
    static let mosaicCard = Color(uiColor: .secondarySystemBackground)
    static let mosaicCard2 = Color(uiColor: .tertiarySystemBackground)
    static let mosaicField = Color(uiColor: .tertiarySystemFill)
    static let mosaicHair = Color(uiColor: .separator)
}

// MARK: - Flat surfaces (cards / pills / buttons)

extension View {
    func mosaicCard(cornerRadius: CGFloat = 20) -> some View {
        self.padding(16)
            .background(Color.mosaicCard, in: RoundedRectangle(cornerRadius: cornerRadius, style: .continuous))
    }

    func mosaicPill() -> some View {
        self.padding(.horizontal, 14).padding(.vertical, 8)
            .background(Color.mosaicCard, in: Capsule())
    }
...
struct FilledAccentButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .background(Color.mosaicAccent, in: Capsule())
